...
//        }
        ...
        val recView = view.findViewById<RecyclerView>(R.id.recViewLang)
        recView.layoutManager = LinearLayoutManager(context)
        recView.adapter = languageListAdapter
    ...
    fun observeViewModel() {   /// di lihat dan di amati
        viewModel.bookLD.observe(viewLifecycleOwner, Observer {
            languageListAdapter.updateBookList(it as ArrayList<Book>) // lari ke bookListAdapter, di update bookListnya
        })
    }
